...
Should work on most distros as there really isn't much to it. Relies mostly on the gnome function that lets you can call a per user login script from a .desktop file in /etc/xdg/autostart
