...
3. You can set a limit to the number of workspaces a user may create:<br>( change this value in z_login.sh by changing the number under this line ############ SET MAX NUMBER OF WORKSPACES HERE ###############
 to whatever you like <br>
