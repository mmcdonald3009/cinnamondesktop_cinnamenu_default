...
2. Some panel functions like Add Panel and Remove Panel REALLY SHOULD be deleted for stability - procedures are below. We keep the ability tp moves the single panel.<br>
