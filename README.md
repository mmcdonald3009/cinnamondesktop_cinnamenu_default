...
4. When a user toggles Show Hidden Files in Nemo, Nemo closes and restarts. Not a perfect solution but should keep kids from accidentally deleting hidden files.<br>
...
And do these removes - the default set is good enough for productive computing and released as part of Cinnamon stable, so no real need to change.
<br>
<br>
